...
func (r PreservedUserResource) DeleteUser(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r PreservedUserResource) ImportUserState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse, uid string) {
