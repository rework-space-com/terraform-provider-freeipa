		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("freeipa_user.user-0", "name", string(managerUser["login"])),
					resource.TestCheckResourceAttr("freeipa_user.user-0", "first_name", string(managerUser["firstname"])),
					resource.TestCheckResourceAttr("freeipa_user.user-0", "last_name", string(managerUser["lastname"])),
				),
			},
			{
				Config: testAccFreeIPAProvider() + testAccFreeIPAUser_resource(managerUser),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("freeipa_user.user-1", "name", string(testUser["login"])),
					resource.TestCheckResourceAttr("freeipa_user.user-1", "first_name", string(testUser["firstname"])),
					resource.TestCheckResourceAttr("freeipa_user.user-1", "last_name", string(testUser["lastname"])),
				),
			},
			{
				Config: testAccFreeIPAProvider() + testAccFreeIPAUser_resource(managerUser) + testAccFreeIPAUser_resource(testUser),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.freeipa_user.user-1", "employee_number", string(testUser["employee_number"])),
					resource.TestCheckResourceAttr("data.freeipa_user.user-1", "employee_type", string(testUser["employee_type"])),
					resource.TestCheckResourceAttr("data.freeipa_user.user-1", "home_directory", string(testUser["home_directory"])),
				),
			},
		},
	})
